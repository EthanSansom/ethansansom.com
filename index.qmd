...
Hi. I’m Ethan, a Masters of Statistics student at the University of Toronto. I also work as a freelance data-analyst for the <a href="https://www.openresearchlab.org/about" class="mono-link">Open Research Lab</a>, a San Fransisco based research group, and for Toronto’s own <a href="https://www.cleanairpartnership.org/about/" class="mono-link">Clean Air Partnership</a>, a charitable environmental organization.

<p style = "padding-top:0px;">My research interests include statistical software design, reproducibility in social science research, and causal inference. Interact with the black boxes ↓ to preview some of my personal projects.</p>

<!--TODO: There's a more idiomatic way to add HTML with :::{.id}, do that--->
<!-- Check this out, seems to be the better way to delcare HTML in Quarto: https://github.com/realworlddatascience/realworlddatascience.github.io/blob/main/index.qmd --->
...
local_host <- "7290"
href_posts_root <- paste0("http://localhost:", local_host, "/")
...
This website is hosted on Netlify, programmed in R, using Quarto. See this <a href="https://github.com/EthanSansom/ethansansom.com" class="mono-link">github repository</a> for the source code. The dynamic elements on this page are programmed using the D3 Javascript library.
:::
