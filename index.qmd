...
mouseover = function(d) {
  d3.select(this)
    .transition()
    .duration("100")
    .attr("width", point_width * 1.5)
    .attr("height", point_height * 1.5)
    .attr("fill-opacity", 1)
}
...
svg.append("g")
  ...
  .append("text")
    .attr("x", d => x(d.x) - (3 * stroke_width) + 4)
    .attr("y", d => y(d.y) - (3 * stroke_width))
    .attr("font-size", "2px")
  ...
  .select(function() { return this.parentNode; })
  .append("a")
    .attr("href", "https://developer.mozilla.org/en-US/docs/Web/SVG/Element/a")
    .append("text")
      .attr("x", d => x(d.x) - (3 * stroke_width) + 4)
      .attr("y", d => y(d.y) - (3 * stroke_width) + 2)
      .attr("font-size", "2px")
      .attr("font-family", "Inter")
      .text("Link")
...
<div id="projects-grid" style = "padding: 1em 0px"></div>
