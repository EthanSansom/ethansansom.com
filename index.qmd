...
```{ojs}
//| echo: false
// output: false // TODO: Add back
d3 = require("d3");

// TODO:
// FIGURE OUT HOW TO UPDATE ON FILTER!!!
// I think the key issue is that I'm trying to rejoin data to a selection that
// already has data associated with it. So maybe I do want .join(update, enter, exit)?
//
// Look at this post on stack AND the comments. It mentions
// transitioning old points to new locations:
// https://stackoverflow.com/questions/22913145/how-to-update-selection-with-new-data-in-d3
