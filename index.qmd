...
This website is hosted on Netlify, programmed with Javascript and R, using Quarto. See this <a href="https://github.com/EthanSansom/ethansansom.com" class="mono-link">github repository</a> for the source code. The dynamic elements on this page were created using the D3 Javascript library.
:::
...
If you'd like to report an issue with this website (a bug and not a misguided aesthetic
