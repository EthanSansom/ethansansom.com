...
mouseover = function(d) {
  ...
  const expand_dir_x = d3.select(this).attr("data-expand-dir-x");
  const expand_dir_y = d3.select(this).attr("data-expand-dir-y");
  ...
  // Raise the parent to the top so that this grid point appears above others
  parent
    .raise()
