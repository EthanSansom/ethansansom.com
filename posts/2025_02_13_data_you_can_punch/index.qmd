...
data = d3
  ...
  .map((year, i) => ({
    ...
    value: (i == 19) ? 190 : Math.max((i * 10) + offsets[i], 10)
  }))
...
// TODO: Tune the options and fix whatever about this makes Quarto mad
/*
body_options = {
  restitution: 0.6,  // Bounciness (0 = no bounce, 1 = perfect bounce)
  friction: 0.3,     // Surface friction (higher = slower slides)
  frictionAir: 0.01, // Air resistance (prevents excessive sliding)
  density: 0.001     // Mass per unit area (affects inertia)
};
*/
