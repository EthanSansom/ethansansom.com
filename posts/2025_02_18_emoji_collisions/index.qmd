...
date: "2025-02-17"
categories: ["draft", "D3", "Matter.js", "Data Visualization"]
...
// TODO: Take a break from creating the emoji hit boxes, now that we've got the
// method down, that's easy. Figure out where to put the SVG on the web-page
// (and how big to make it), so that it takes up the entire floor. We don't actually
// need to do that much work to make the sizing responsive, we just need to pick
// an appropriate height and width (aspect ratio) such that it re-sizes correctly!
